...
def get_ssh_keys():
    ...
    # Adding some error handling by looking at HTTP status code in the response.
    if response.status_code >= 500:
        ...
        print ('[0] [{0}] Unexpected Redirect'.format(response.status_code))
        return None
...
# Calling above function and assign it to the ssh_keys variable:
